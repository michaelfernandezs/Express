  ...
  try {
    ...
    const scrapedData = await page.evaluate(() => {
      ...
      if (hostname.includes('mercadolibre')) {
        ...
        description =
          document.querySelector('.ui-pdp-description__content')?.innerText ||
          description;
        image =
        ...
        price =
          document.querySelector('.a-stickyBar__price')?.innerText || price;
        description =
          document.querySelector(
            '.a-product__paragraphProductDescriptionContentWeb.d-none.d-lg-block.m-0.mt-2.hidedesc'
